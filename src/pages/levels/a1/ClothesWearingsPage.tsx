 ...
 <div className="min-h-screen bg-teal-50 p-6 font-['Roboto']">
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={0} max={31} isVocab={true} />
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={32} max={51} isVocab={true} />
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={52} max={65} isVocab={true} />
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={66} max={77} isVocab={true} />
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={78} max={88} isVocab={true} />
      ...
      <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                  ...
                  <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                      ...
                      <ConjugationTable days={clothesData.clothesWearings} min={89} max={clothesData.clothesWearings.length-1} isVocab={true} />
