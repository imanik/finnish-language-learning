  ...
  <div className="min-h-screen bg-teal-50 p-6 font-['Roboto']">
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={0} max={12} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={13} max={37} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={38} max={76} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={77} max={98} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={99} max={122} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={123} max={141} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={142} max={171} isVocab={true} />
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-200 p-6 rounded-lg shadow-lg max-w-2xl mx-auto mb-6">
                    ...
                    <section className="bg-white rounded-lg border border-gray-300 p-4 mb-6">
                        ...
                        <ConjugationTable days={foodData.foodsDrinks} min={172} max={foodData.foodsDrinks.length-1} isVocab={true} />
