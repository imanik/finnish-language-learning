import { animalData, bodyPartData, langaugeData, adjectivesData, verbData, greetingsData, nationalityData, familyData, numberData,
  ...
  { name: "nationality", data: nationalityData },
  { name: "adjectives", data: adjectivesData },
  ...
  { name: "verb", data: verbData },
  { name: "phrase", data: phraseData },
  { name: "greeting", data: greetingsData },
  { name: "day", data: dayData },
  { name: "month", data: monthData },
  { name: "time", data: timeData },
  { name: "weather", data: weatherData },
  { name: "room", data: roomData },
  { name: "illness", data: illnessData },
  { name: "color", data: colorData},
