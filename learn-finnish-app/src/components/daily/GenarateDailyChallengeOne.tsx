            ...
            import { ArrowDownCircleIcon } from "@heroicons/react/24/solid";
                    ...
                    function GenerateDailyChallengeOne<T extends ChallengeItem>({item, optionsPool, onNext, onAnswer, onReset, handleQuizComplete} : GenarateDailyChallengeOneProps<T>){
          ...
          ({option.pronunciation ?? ""})
            ...
            {isCorrect === null ? (
              ...
              <ArrowDownCircleIcon className="h-5 w-5 animate-pulse text-cyan-400" />{" "}
                    ...
                    export default GenerateDailyChallengeOne